...
const categories = ["All Projects", "Full Stack", "Frontend", "Backend", "Mobile"];

export default function ProjectGallery() {
    return (
        <section className="py-20 px-6 container mx-auto">
            {/* Header - Server Side for SEO */}
            <div className="text-center mb-12">
                <h2 className="text-4xl font-bold mb-8">All Projects</h2>
            </div>

            {/* Client Logic for Filtering & Animation */}
            <ProjectGalleryClient projects={projects} categories={categories} />
        </section>
    );
}